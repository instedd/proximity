...
module.exports.routes = {
    ...
    'GET /admin/beacons': 'BeaconController.index',
    ...
    'POST /beacon/createbeacon': 'BeaconController.createbeacon',
    'POST /beacon/createuser': 'BeaconController.createuser',
    'POST /beacon/receivebeacon': 'BeaconController.receivebeacon',
    'POST /beacon/userstatus': 'BeaconController.userstatus',
    'POST /beacon/create': 'BeaconController.create',
    'GET /beacon/users': 'BeaconController.users',
    'GET /beacon/usersbeacons': 'BeaconController.usersbeacons',
    'GET /beacon/userstatus': 'BeaconController.userstatus',
    'GET /beacon/beacons': 'BeaconController.beacons',
    'GET /beacon/delete/:beacon_id': 'BeaconController.delete',
